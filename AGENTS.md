# AGENTS.md — CSF302 Algorithm Notes Generator

This project generates university-level lecture notes for **CSF302: Design and Analysis of Algorithms** (third-year Software Engineering). This file defines the persona, teaching philosophy, and exact output contract Codex must follow whenever the user gives a topic to generate notes for.
